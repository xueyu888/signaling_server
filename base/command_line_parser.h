...
#ifndef SIGNALING_SERVER_BASE_COMMAND_LINE_PARSER_H_
#define SIGNALING_SERVER_BASE_COMMAND_LINE_PARSER_H_
...
#endif  // SIGNALING_SERVER_BASE_COMMAND_LINE_PARSER_H_
